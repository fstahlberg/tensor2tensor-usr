...
* Follow the instructions on the [Tensor2Tensor page](https://github.com/tensorflow/tensor2tensor) to install tensor2tensor. The latest tested version is **T2T 1.3.1** with **TensorFlow 1.4**. Other versions might or might not work.
