...
def transformer_ext_v1():
  ...
  # self_att, rnn, birnn, enc_att, t_self_att, nt_self_att, osm_self_att, parent_ffn, enc_pop_att, enc_pop_pos_att
...
@registry.register_hparams
def transformer_ext_no_feedback():
  """Hparams for parsing on wsj only."""
  hparams = transformer_ext_v2()
  hparams.add_hparam("no_feedback", True)
  return hparams


@registry.register_hparams
def transformer_ext_parent_ffn():
  """Hparams for parsing on wsj only."""
  hparams = transformer_ext_v2()
  hparams.decoder_layer_types = "parent_ffn:1,self_att,enc_att"
  return hparams


@registry.register_hparams
def transformer_ext_rpos():
  """Hparams for parsing on wsj only."""
  hparams = transformer_ext_v2()
  hparams.encoder_pos_integration = "ffn"
  hparams.decoder_pos_integration = "ffn"
  hparams.pos_embed = "rnn"
  hparams.daisy_chain_variables = False
  hparams.add_hparam("no_caching_devices", True)
  return hparams


@registry.register_hparams
def transformer_ext_tree():
  """Hparams for parsing on wsj only."""
  hparams = transformer_ext_v1()
...
@registry.register_hparams
def transformer_ext_tnt():
  """Hparams for parsing on wsj only."""
  hparams = transformer_ext_v2()
  hparams.decoder_pos = "timing:2000,depth:1000,t_timing:2000,nt_timing:2000,parent_timing:2000"
  hparams.decoder_pos_integration = "ffn"
  hparams.decoder_layer_types = "nt_self_att,t_self_att,enc_att"
  hparams.num_decoder_layers = 4
  return hparams

@registry.register_hparams
def transformer_ext_tnt_large_batch4():
  """Hparams for parsing on wsj only."""
  hparams = transformer_ext_v2()
  hparams.decoder_pos = "timing:2000,depth:1000,t_timing:2000,nt_timing:2000,parent_timing:2000"
  hparams.decoder_pos_integration = "ffn"
...
@registry.register_hparams
def transformer_ext_tnt2():
  """Hparams for parsing on wsj only."""
  hparams = transformer_ext_v2()
  hparams.decoder_pos = "t_timing:5000,nt_timing:5000"
  hparams.decoder_layer_types = "nt_self_att,t_self_att,enc_att"
  hparams.num_decoder_layers = 4
  return hparams
...
@registry.register_hparams
def transformer_ext_tnt2_large_batch8():
  """Hparams for parsing on wsj only."""
  hparams = transformer_ext_v2()
  hparams.decoder_pos = "t_timing:5000,nt_timing:5000"
  hparams.decoder_layer_types = "nt_self_att,t_self_att,enc_att"
...
@registry.register_hparams
def transformer_ext_parent_ffn_large_batch4():
  """Hparams for parsing on wsj only."""
  hparams = transformer_ext_v2()
  hparams.decoder_layer_types = "parent_ffn:1,self_att,enc_att"
  hparams.fake_gpu_multiplier = 4
...
@registry.register_hparams
def transformer_ext_parent_ffn2_large_batch4():
  """Hparams for parsing on wsj only."""
  hparams = transformer_ext_v2()
  hparams.decoder_pos = "t_timing:5000,timing:5000"
  hparams.decoder_layer_types = "parent_ffn:1,t_self_att:2,self_att,enc_att"
  hparams.fake_gpu_multiplier = 4
  hparams.optimizer = "LargebatchAdam"
  return hparams
...
@registry.register_hparams
def transformer_ext_tnt2_large_batch4():
  """Hparams for parsing on wsj only."""
  hparams = transformer_ext_v2()
  hparams.decoder_pos = "t_timing:5000,nt_timing:5000"
  hparams.decoder_layer_types = "nt_self_att,t_self_att,enc_att"
...
@registry.register_hparams
def transformer_ext_tnt3():
  """Hparams for parsing on wsj only."""
  hparams = transformer_ext_v2()
  hparams.decoder_pos = "t_timing"
  hparams.decoder_layer_types = "t_self_att,enc_att"
  return hparams


@registry.register_hparams
def transformer_ext_debug():
  """Hparams for parsing on wsj only."""
  hparams = transformer_ext_v1()
  hparams.decoder_pos = "timing,depth,bfs,num_left_global,parent_timing,parent_bfs,parent_num_left_global,t_timing,nt_timing" 
  hparams.decoder_pos_integration = "ffn"
  hparams.add_hparam("no_feedback", True)
  return hparams
...
@registry.register_hparams
def transformer_ext_osm_large_batch8():
  """Hparams for parsing on wsj only."""
  hparams = transformer_ext_v2()
  hparams.decoder_layer_types = "enc_pop_att:1,self_att,enc_att"
  hparams.fake_gpu_multiplier = 8
  hparams.optimizer = "LargebatchAdam"
  return hparams

@registry.register_hparams
def transformer_ext_osm_large_batch64():
  """Hparams for parsing on wsj only."""
  hparams = transformer_ext_v2()
  hparams.decoder_layer_types = "osm_self_att,enc_pop_pos_att"
  hparams.fake_gpu_multiplier = 64
  hparams.optimizer = "LargebatchAdam"
  return hparams

@registry.register_hparams
def transformer_ext_osmmix2_large_batch32():
  """Hparams for parsing on wsj only."""
  hparams = transformer_ext_v2()
  hparams.decoder_layer_types = "osm_self_att:3,self_att:3:,enc_pop_pos_att:3,enc_att:3:"
